...
import Functions_Wgp as Foo

from Models_Wgp import Generator
from Models_Wgp import Discriminator
...
def main():
    ...
    dataloader_test_CT = torchdata.DataLoader(dataset_CT_test, batch_size=bs, shuffle=False, num_workers=workers)
    ...
    dataloader_test_MR = torch.utils.data.DataLoader(dataset_MR_test, batch_size=bs, shuffle=False, num_workers=workers)
